...
const mediaMetaSchema = z
  .object({
    ...
    codec: z
      .object({ audio: codecSchema.optional(), video: codecSchema.optional() })
      .optional(),
...
const mediaSchema = z
  .object({
    ...
    access_restrictions: z
      .object({ enabled: z.boolean().optional(), rule: z.string().optional() })
      .optional(),
