---
name: agent3-design
description: Test Designer — diseña test cases concretos por capa (smoke/regression/integration/contract) a partir del impact map. Tercer agente del pipeline /generate-tests.
---
...
- NO incluir en el plan tests con cobertura completa (`coverage: "covered"`) — omitir completamente
